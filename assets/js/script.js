...
var taskStatusChangeHandler = function(event) {
    ...
    console.log(tasks);
    saveTasks(taskStatusChangeHandler);
};
...
// iterates through tasks of array and creates task elementson thep page from it
